...
import com.synerf.roomdemo.databinding.ActivityMainBinding
import com.synerf.roomdemo.databinding.DialogUpdateBinding
        ...
        binding.tvUpdate.setOnClickListener {
            ...
            if (name.isNotEmpty() && email.isNotEmpty()) {
                lifecycleScope.launch {
                    ...
                    Toast.makeText(applicationContext, "Record Updates", Toast.LENGTH_LONG).show()
